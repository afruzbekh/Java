...
// System.out.println("Once upon a time there was " + characterName + ", who was
// a " + characterJob + ". On the way to work, " + characterName + " reflected
// on life. Perhaps " + characterName + " will not be a " + characterJob + "
// forever.");
// }
// }
// import java.util.Scanner;
...
// System.out.println(number + " days are equal to " + number * 86400 + "
// seconds!");
// int first = 10;
// int second = first + 5;
// first = 20;
...
// int speedingTicketChecker = Integer.valueOf(scanner.nextLine());
// if (speedingTicketChecker >= 120) {
...
// int squareNumber = Integer.valueOf(scanner.nextLine());
// int squareNumber2 = Integer.valueOf(scanner.nextLine());
// System.out.println(Math.sqrt(squareNumber + squareNumber2));
